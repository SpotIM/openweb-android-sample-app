...
object MockImplementationInfo {
    fun news() = ImplementationInfo(
    ...
    fun finance() = ImplementationInfo(
    ...
    fun recipes() = ImplementationInfo(
    ...
    fun sideRail() = ImplementationInfo(
