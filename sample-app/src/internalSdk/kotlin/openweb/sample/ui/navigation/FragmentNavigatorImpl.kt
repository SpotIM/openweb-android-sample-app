...
/**
 * Implementation of FragmentNavigator using manual fragment transactions.
 * Only needs a FragmentActivity reference - gets FragmentManager from it.
 */
class FragmentNavigatorImpl(
    ...
    /**
     * Helper method to replace fragments with consistent animations.
     * Uses slide animations matching the SettingsActivity pattern.
     */
